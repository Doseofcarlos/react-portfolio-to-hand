        ...
        <div className='cards__wrapper'>
          <ul className='cards__items'>
            <CardItem
              ...
              label='Assignmet'
              path='https://co-employee-directory.herokuapp.com/'
            />
            <CardItem
              ...
              label='Project'
              path='https://still-sea-96387.herokuapp.com/'
            />
          </ul>
          <ul className='cards__items'>
            <CardItem
              ...
              label='Assignment'
              path='https://co-progressive-budget.herokuapp.com/'
            />
            <CardItem
              ...
              label='assignment'
              path='https://co-fitness-tracker.herokuapp.com/'
            />
          </ul>
        </div>
      </div>
